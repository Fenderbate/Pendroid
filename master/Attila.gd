...
func Normal():
	get_node("Sprite").set_texture(load("res://_src/Enemies/Attila/normal.png"))

func Happy():
	get_node("Sprite").set_texture(load("res://_src/Enemies/Attila/happy.png"))

func Angry():
	get_node("Sprite").set_texture(load("res://_src/Enemies/Attila/angry.png"))

func Sad():
	get_node("Sprite").set_texture(load("res://_src/Enemies/Attila/sad.png"))
